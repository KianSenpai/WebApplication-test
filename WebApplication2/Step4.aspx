...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <gup-wizard-main>
        <gup-details closed-icon="add-circle" open-icon="remove-circle">
            <span slot="label">Step 4 of 8</span>
            <gup-stepper style="" static-mode="">
                ...
                <gup-stepper-item step-number="4" role="listitem" step-type="selected" static-mode="">
        ...
        <gup-form-section>
            <span slot="title" style="font-weight: 600">Highschool academic details</span>
            <br />
